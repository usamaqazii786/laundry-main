...
class Disable_Trackback extends Component {
	...
	public function to_array() {
		return [
			'slug'             => $this->slug,
			'title'            => __( 'Disable trackbacks and pingbacks', 'defender-security' ),
			'errorReason'      => __( 'Trackbacks and pingbacks are currently enabled.', 'defender-security' ),
			'successReason'    => __( 'Trackbacks and pingbacks are disabled, nice work!', 'defender-security' ),
			'misc'             => [],
			'bulk_description' => __( 'Trackbacks and pingbacks can lead to DDos attacks and tons of spam comments. If you don’t require this feature, we recommend turning it off.', 'defender-security' ),
			'bulk_title'       => __( 'Trackbacks and pingbacks', 'defender-security' ),
		];
	}
}

...
class Disable_XML_RPC extends Component {
	...
	public function to_array() {
		return [
			'slug'             => $this->slug,
			'title'            => __( 'Disable XML-RPC', 'defender-security' ),
			'errorReason'      => __( 'XML-RPC is currently enabled.', 'defender-security' ),
			'successReason'    => __( 'XML-RPC is disabled, great job!', 'defender-security' ),
			'misc'             => [],
			'bulk_description' => __( 'In the past, there were security concerns with XML-RPC so we recommend making sure this feature is fully disabled if you don’t need it active. We will disable XML-RPC for you.', 'defender-security' ),
			'bulk_title'       => 'XML-RPC'
		];
	}
}

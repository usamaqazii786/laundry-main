	...
	public function to_array(): array {
		...
		return [
			...
			/* translators: %s: Min PHP version. %s: Min PHP version. */
				__( "PHP versions older than %s are no longer supported. For security and stability we strongly recommend you upgrade your PHP version to version %s or newer as soon as possible.", 'defender-security' ),
				$this->min_php,
				$this->min_php
			),

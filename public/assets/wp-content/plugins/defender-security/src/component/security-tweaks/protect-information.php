...
class Protect_Information extends Component {
	...
	public function to_array() {
		return [
			'slug'            => $this->slug,
			'title'           => __( 'Prevent Information Disclosure', 'defender-security' ),
			'errorReason'     => __( 'You don\'t have information disclosure protection active.', 'defender-security' ),
			'successReason'   => __( 'You\'ve automatically enabled information disclosure protection.', 'defender-security' ),
			'misc'            => [
			...
			'blk_description' => __( 'Often servers are incorrectly configured, and can allow an attacker to get access to sensitive files like your config, .htaccess and backup files. We will automatically add an .htaccess file to your root folder to action this fix.', 'defender-security' ),
			'bulk_title'      => __( 'Information Disclosure', 'defender-security' )
		];
	}
}

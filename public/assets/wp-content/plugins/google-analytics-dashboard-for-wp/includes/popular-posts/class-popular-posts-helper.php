...
/**
 * Class ExactMetrics_Popular_Posts_Helper
...
class ExactMetrics_Popular_Posts_Helper {
	...
	private function clear_cache() {
		...
		ExactMetrics_Popular_Posts_Inline()->get_cache()->delete_data();
		ExactMetrics_Popular_Posts_Widget()->get_cache()->delete_data();

		if ( exactmetrics_is_pro_version() ) {
			ExactMetrics_Popular_Posts_Products()->get_cache()->delete_data();
		}
	}
...
ExactMetrics_Popular_Posts_Helper::get_instance();

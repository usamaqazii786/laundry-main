 ...
 * @since 8.19.0
 */
class ExactMetrics_Summaries_InfoBlocks {
	 ...
	 * @since 8.19.0
	 */
	const SOURCE_URL = 'https://plugin-cdn.exactmetrics.com/summaries.json';
	...
	protected function filter_by_current_date( $data ) {
		...
		$blocks_sent = get_option( 'exactmetrics_email_summaries_infoblocks_sent' );
	...
	public function register_sent( $info_block ) {
		...
		$option_name = 'exactmetrics_email_summaries_infoblocks_sent';
